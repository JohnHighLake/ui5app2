					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Application 2",
									"targetURL": "#jgui5app2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"jgui5app2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jg.ui5app2",
									"url": sap.ui.require.toUrl("jg/ui5app2")
								}
							}
						}
					}
